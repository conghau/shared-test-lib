...
var Wrapper = styled.i.withConfig({
...
var Icon = function Icon(_ref) {
  ...
  }, SVGIcon ? React.createElement(SVGIcon, _extends({
    width: "1em",
    height: "1em"
...
var MenuIcon = styled(Icon).withConfig({
...
var Gutter = styled.div.withConfig({
...
var Action = styled.button.withConfig({
...
var Wrapper$1 = styled.li.withConfig({
  displayName: "MenuItem__Wrapper",
  componentId: "sc-18jf3fc-4"
})(["display:flex;", " ", ""], function (_ref) {
  var active = _ref.active;
  return active && css(["", ":before{opacity:1;}", ",", "{color:", ";}"], Gutter, MenuIcon, Label, function (props) {
    return props.theme.sideBar.menuTextHoverColor;
  });
}, function (_ref2) {
  var collapsed = _ref2.collapsed;
  return collapsed && css(["", "{width:28px;&:before{width:14px;}}", "{max-width:0;opacity:0;}"], Gutter, Label);
});
    ...
    value: function render() {
      ...
      return React.createElement(Route, {
        ...
        children: function children(_ref3) {
          ...
          return React.createElement(Wrapper$1, _extends({}, rest, {
            className: className,
            active: active || match && to,
            collapsed: collapsed
          }), React.createElement(Gutter, null), React.createElement(Action, {
            as: to ? Link : 'button',
            to: to,
            onClick: onClick
...
var StyledMenuItem = styled(MenuItem$1).withConfig({
  displayName: "Menu__StyledMenuItem",
  componentId: "sc-1x0rufb-0"
})([""]);
var Wrapper$2 = styled.ul.withConfig({
...
var IndicatorIcon = styled.div.withConfig({
...
var TogglerWrapper = styled.div.withConfig({
...
var Toggler = function Toggler(_ref) {
  ...
  return React.createElement(TogglerWrapper, {
    className: className,
    type: "button",
    onClick: onToggle
  }, React.createElement(IndicatorLine, {
    collapsed: collapsed
  }), React.createElement(IndicatorIcon, {
    collapsed: collapsed
...
var Title = styled.h1.withConfig({
  ...
  var collapsed = _ref.collapsed;
  return collapsed && css(["font-size:0;padding:0;&:before{opacity:1;}"]);
});

var Wrapper$3 = styled.nav.withConfig({
...
var FooterMenu = styled(Menu).withConfig({
    ...
    value: function render() {
      ...
      return React.createElement(Wrapper$3, {
        ...
        return React.createElement(React.Fragment, {
          ...
          collapsed: collapsed
        }, group.name), React.createElement(Menu, {
          collapsed: collapsed
        }, group.items.map(function (Item) {
          return Item;
        })));
      }), footerMenu.length > 0 && React.createElement(FooterMenu, {
        collapsed: collapsed
...
export { theme, Icon, Menu, MenuItem$1 as MenuItem, SideBar as Sidebar };
